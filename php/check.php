...
//查詢訂單和pphoto
	$sqlstr1 = "SELECT orderid,name,pid,pphoto,pname,amount,price,total,phone,address,payway,situation FROM `Order` WHERE orderid = '$orderid' AND name = '$name';";
	...
	"<table width='1450' class='style1'>
	  <tr style='text-align: center;' >
	    ...
	    <td class='col-1 imgh'><img src=../$row[3] style='background-size:contain;height:75px'></td>
